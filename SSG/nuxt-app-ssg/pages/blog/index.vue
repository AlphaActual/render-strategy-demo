...
// SEO
useSeoMeta({
  title: "Blog Posts - Nuxt App SSG",
  description:
    "Discover amazing articles and stories from our community. Browse through our collection of blog posts generated using Static Site Generation (SSG).",
  ogTitle: "Blog Posts - Nuxt App SSG",
  ogDescription:
    "Discover amazing articles and stories from our community. Browse through our collection of blog posts generated using Static Site Generation (SSG).",
  ogType: "website",
  twitterCard: "summary_large_image",
  twitterTitle: "Blog Posts - Nuxt App SSG",
  twitterDescription:
    "Discover amazing articles and stories from our community. Browse through our collection of blog posts generated using Static Site Generation (SSG).",
});
</script>
