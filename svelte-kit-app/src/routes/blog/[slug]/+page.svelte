...
<svelte:head>
  ...
  <meta name="description" content={post?.body?.substring(0, 160) || 'Read this amazing blog post'} />
</svelte:head>
  ...
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {#if error}
      <div class="text-center py-12">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-2">Error loading post</h3>
    ...
    {:else if post && author}
      ...
      <article class="bg-white rounded-xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
              ...
              <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-blue-600 font-medium mb-2">@{author.username}</p>
        ...
        <!-- Comments Section -->
        <div class="border-t bg-gradient-to-b from-gray-50 to-white px-6 py-8 sm:px-8">          <h3 class="text-2xl font-bold text-gray-900 mb-6">
      ...
      <div class="mt-12">
        <div class="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-8 border border-blue-100">
          ...
          <div class="flex flex-col sm:flex-row justify-between gap-4">            {#if post.id > 1}
              <a 
                href="/blog/{post.id - 1}"
              ...
              >
                ...
                <div class="relative z-10 flex items-center">
                  ...
                  <div class="ml-4 flex-1">
                    ...
                    <div class="font-bold text-gray-900 group-hover:text-blue-700 transition-colors duration-300">Post {post.id - 1}</div>
